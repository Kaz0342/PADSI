...
<div class="form-container">
    ...
    <form id="pegawaiForm" method="POST" action="{{ route('pegawai.update', $pegawai->id) }}">
        @csrf
        @method('PUT')

        <div class="form-group">
            <label>ID Pegawai :</label>
            <input type="text" value="{{ $pegawai->id }}" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="role">
                ...
                <option value="Barista" {{ $pegawai->role == 'Barista' ? 'selected' : '' }}>Barista</option>
...
<div class="modal" id="confirmModal">
    <div class="modal-content">
        <p>Yakin untuk memperbarui data?</p>
